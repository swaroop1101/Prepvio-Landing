	...
	return (
		...
		>
			...
			<div className='space-y-6'>
				...
				>
					<h3 className='text-xl font-semibold text-indigo-500 mb-3'>Profile Information</h3>
				...
				>
					<h3 className='text-xl font-semibold text-indigo-500 mb-3'>Account Activity</h3>
